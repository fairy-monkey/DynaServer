...
@RestController
@RequestMapping("/facade/dyna/book/favor/app")
public class DynaBookFavorAppController {
    @Autowired
    private IDynaBookFavorAppService dynaFavorAppService;
    ...
    public ObjectResponse<Boolean> doFavor(@RequestBody DynaBookCommentFavorDTO dto) {
