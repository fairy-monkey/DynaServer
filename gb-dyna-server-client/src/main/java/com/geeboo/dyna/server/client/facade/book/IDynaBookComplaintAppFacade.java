...
public interface IDynaBookComplaintAppFacade {
    /**
     * 举报评论
     *
     * @param dto
     * @return
     */
    @PostMapping(value = "/DynaServer/facade/dyna/book/complaint/app/complaint")
    BaseResponse complaint(@RequestBody DynaBookComplaintDTO dto);
}