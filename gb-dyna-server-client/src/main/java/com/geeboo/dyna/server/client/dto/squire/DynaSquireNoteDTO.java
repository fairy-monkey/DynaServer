 ...
 */
public class DynaSquireNoteDTO extends ParentDTO implements Serializable {
    ...
    public DynaSquireNoteDTO() {
    }

    public DynaSquireNoteDTO(Integer bookUserId, Integer businessId) {
    ...
    public String toString() {
        return "DynaSquireNoteDTO{" + "dynaSquireId=" + dynaSquireId + ", userId=" + userId + ", bookUserId="
