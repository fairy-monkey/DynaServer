...
public class DynaBookComplaintDTO implements Serializable {
    ...
    public Integer getDynaBookComplaintId() {
        return dynaBookComplaintId;
    }

    public void setDynaBookComplaintId(Integer dynaBookComplaintId) {
        this.dynaBookComplaintId = dynaBookComplaintId;
    }
    ...
    public String toString() {
        return "DynaBookComplaintDTO{" + "dynaBookComplaintId=" + dynaBookComplaintId + ", bookUserId=" + bookUserId
