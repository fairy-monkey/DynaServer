...
public class DynaCourseComplaintDTO implements Serializable {
    ...
    public Integer getDynaCourseComplaintId() {
        return dynaCourseComplaintId;
    }

    public void setDynaCourseComplaintId(Integer dynaCourseComplaintId) {
        this.dynaCourseComplaintId = dynaCourseComplaintId;
    }
    ...
    public String toString() {
        return "DynaCourseComplaintDTO{" + "dynaCourseComplaintId=" + dynaCourseComplaintId + ", courseId=" + courseId
            + ", complaintContent='" + complaintContent + '\'' + ", complaintType=" + complaintType + ", userId="
            + userId + ", toUserId=" + toUserId + ", complaintStatus=" + complaintStatus + ", contentId=" + contentId
            + ", complaintObj=" + complaintObj + ", createTime=" + createTime + ", createBy=" + createBy
