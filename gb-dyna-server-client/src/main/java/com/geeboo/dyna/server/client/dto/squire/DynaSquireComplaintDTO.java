...
public class DynaSquireComplaintDTO implements Serializable {
    ...
    public Integer getSquireComplaintId() {
        return squireComplaintId;
    }

    public void setSquireComplaintId(Integer squireComplaintId) {
        this.squireComplaintId = squireComplaintId;
    }
    ...
    public String toString() {
        return "DynaSquireComplaintDTO{" + "squireComplaintId=" + squireComplaintId + ", dynaSquireId="
            + dynaSquireId + ", complaintContent='" + complaintContent + '\'' + ", complaintType=" + complaintType
