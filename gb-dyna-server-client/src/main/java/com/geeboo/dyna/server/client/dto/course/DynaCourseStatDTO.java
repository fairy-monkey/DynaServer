...
public class DynaCourseStatDTO implements Serializable {
    ...
    public static DynaCourseStatDTO getNullInstance() {
        DynaCourseStatDTO
            dto = new DynaCourseStatDTO();
        dto.setNumView(0);
        dto.setNumComment(0);
        dto.setNumReply(0);
        dto.setNumTotal(0);
    ...
    public Integer getDynaCourseStatId() {
        return dynaCourseStatId;
    }

    public void setDynaCourseStatId(Integer dynaCourseStatId) {
        this.dynaCourseStatId = dynaCourseStatId;
    }
    ...
    public String toString() {
        return "DynaCourseStatDTO{" + "dynaCourseStatId=" + dynaCourseStatId + ", courseId=" + courseId + ", numView="
